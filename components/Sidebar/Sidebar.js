...
export default function Sidebar() {
  ...
  return (
    <>
      <nav className="md:left-0 md:block md:fixed md:top-0 md:bottom-0 md:overflow-y-auto md:flex-row md:flex-nowrap md:overflow-hidden shadow-xl bg-white flex flex-wrap items-center justify-between relative md:w-56 z-10 py-4 px-6">
        <div className="md:flex-col md:items-stretch md:min-h-full md:flex-nowrap px-0 flex flex-wrap items-center justify-between w-full mx-auto">
          ...
          <Link href="/" legacyBehavior>
            ...
            >
              <img className="h-auto w-[250px]" src="https://storage.googleapis.com/primesecure/logo-prime-secure.webp" alt="Logo Prime Secure"/>
            </a>
          </Link>
          {/* User */}
